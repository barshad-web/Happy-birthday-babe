...
A no-build, single-page birthday celebration website for My Beb. It is intentionally dependency-free: open `index.html` directly or serve the folder from any static host.
