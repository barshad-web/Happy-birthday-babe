...
const CONFIG = {
  name: 'My Beb',
  message: "Happy Birthday My Dear Babe. You are the Best and the Most Valuable Person in my Life. Today is the most special day for you're life. Be always what you are because You are the Best. I Love You Babe 😘"
};

const defaultMemories = [
  { src: 'images/IMG_20260423_133902_070.jpg', caption: 'sweet things for a sweet soul', date: 'a little while ago' },
  { src: 'images/IMG_20260708_211423_995.jpg', caption: 'more Gorgeous , Day by Day', date: 'Every Day' },
  { src: 'images/IMG_20260913_120410_227.jpg', caption: 'Angel of this world', date: 'you are my favorite ' },
  { src: 'images/IMG-20260427-WA0010.jpg', caption: 'kindest person ever', date: 'today & always' },
  { src: 'images/Messenger_creation_8F9E19FB-7442-4FAB-A2BC-A076AFE199D3.jpeg', caption: 'the person who love you', date: 'always nearby' }
];
...
function getWishes() { return loadLocal(wishesKey, [
  { name: 'Barshad', message: 'Be happy and makemore reasons to laugh until your cheeks hurt. I Love you!', sticker: '♡', accent: '#e55d88', tilt: '-2deg' },
  ...
  { name: 'Dudu', message: 'I hope you have the most joy-filled year yet!', sticker: '✿', accent: '#e79b3f', tilt: '-1deg' },
  { name: 'Bubu', message: 'Keep shining exactly as you do. Big birthday energy always!', sticker: '🎈', accent: '#57917b', tilt: '3deg' }
]); }
...
function setupShare() {
  $('#shareButton').addEventListener('click', async () => {
    const shareData = { title: 'A little birthday moment for My Beb', text: 'There is a birthday surprise waiting for you ✦', url: window.location.href };
